...
def standardize_data():
    ...
    # Map column names for standardization
    column_mapping_iheartjane = {
    ...
    df_iheartjane = df_iheartjane.rename(columns=column_mapping_iheartjane)
    df_dutchiezen = df_dutchiezen.rename(columns=column_mapping_dutchiezen)
