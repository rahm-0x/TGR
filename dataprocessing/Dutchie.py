...
# Dispensaries and pagination variables
dispensary_ids = {
    ...
    "6125d70cc98d6a00d1e1e859": "Cannastarz",
    ...
    while True:
        ...
        if response.status_code == 200:
            ...
            for product in products:
                ...
                # **Filter by Grower Circle brands**
                if brand_name.lower() in grower_circle_brands:
                    ...
                    print(f"  Skipped product: {product_name} (Brand: {brand_name})")
...
if all_data:
    send_to_firestore(all_data, "dutchie_zen_TGCONLY")
else:
