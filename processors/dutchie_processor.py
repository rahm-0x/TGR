...
from firebasedata_fetcher import fetch_inventory_data  # Import Firestore fetcher
...
# Main processor for dutchieZen data from Firestore
def process_dutchiezen_data():
    # Fetch data from Firestore
    st.info("Fetching data from Firestore...")
    df_dutchieZen = fetch_inventory_data("dutchie_zen")  # Specify Firestore collection

    if df_dutchieZen.empty:
